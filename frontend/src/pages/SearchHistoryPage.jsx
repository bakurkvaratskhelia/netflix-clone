    ...
    return (
      <div className='bg-black min-h-screen text-white'>
        ...
        <div className='max-w-6xl mx-auto px-4 py-8'>
          ...
          <div className='felx justify-center items-center h-96'>
            <p className='text-x1'>No search history found</p>
          </div>
        </div>
      </div>
    );
          ...
          {searchHistory?.map((entry) => (
            <div key={entry.id} className='bg-gray-800 p-4 rounded flex items-start'>
              ...
              <div className='flex flex-col'>
                ...
                <span className='text-grey-400 text-sm'>{formatDate(entry.createdAt)}</span>
              </div>
